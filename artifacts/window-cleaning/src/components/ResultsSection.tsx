          ...
          <div key={pair.label}>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="relative rounded-xl overflow-hidden aspect-square">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 bg-black/50 text-white text-xs font-semibold text-center py-1">
                  Ennen
                </div>
              </div>
              <div className="relative rounded-xl overflow-hidden aspect-square">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-primary/70 text-white text-xs font-semibold text-center py-1">
                  Jälkeen
                </div>
              </div>
            </div>
